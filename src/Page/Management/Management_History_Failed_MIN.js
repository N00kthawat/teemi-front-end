...
const Management_History_Failed_MIN = () => {
    ...
    const HistorySUC = () => {
        navigate("/management_historysuc");
    };
    useEffect(() => {
    ...
    const fetchHistory = debounce(async (id) => {
        try {
            const response = await axios.get(`${API_URL}/all-history-you-failed-min`, {
                params: {
                    ID_user: id,
                    search: searchTerm
                }
                    ...
                    <div className="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white">
                        <div>
                            ...
                            <div class="inline-flex rounded-md shadow-sm" role="group"
                                ...
                                <button type="button" onClick={HistorySUC} 
                                        class="px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border-t border-b border-gray-900 hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700">
                                    สำเร็จ
                                </button>
                                <button type="button" class="px-4 py-2 text-sm font-medium text-white bg-black border border-black rounded-e-lg hover:bg-gray-800 focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-700">
                                    ไม่สำเร็จ
                                </button>
                            ...
                            <div className="relative inline-block" style={{ marginLeft:"10px" }}>
                                ...
                                {isOpen && (
                                    ...
                                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                                        <li>
                                        <a href="/management_historyfailed_max" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                            >ล่าสุด</a>
                                        </li>
                                        <li>
                                        <a href="/management_historyfailed" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                            >ค่าเริ่มต้น</a>
                                        </li>
                                    </ul>
                                    </div>
...
export default Management_History_Failed_MIN;
