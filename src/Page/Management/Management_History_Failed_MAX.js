...
const Management_History_Failed_MAX = () => {
    ...
    const fetchHistory = debounce(async (id) => {
        try {
            const response = await axios.get(`${API_URL}/all-history-you-failed-max`, {
                params: {
                    ID_user: id,
                    search: searchTerm
                }
                            ...
                            <div className="relative inline-block" style={{ marginLeft:"10px" }}>
                                ...
                                {isOpen && (
                                    ...
                                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                                        ...
                                        <li>
                                        <a href="/management_historyfailed_min" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                            >เก่าสุด</a>
                                        </li>
                                    </ul>
                                    </div>
...
export default Management_History_Failed_MAX;
