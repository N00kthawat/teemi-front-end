...
const Management_History_MIN = () => {
    ...
    const fetchHistory = debounce(async (id) => {
        try {
            const response = await axios.get(`${API_URL}/all-history-you-MIN`, {
                params: {
                    ID_user: id,
                    search: searchTerm
                }
                ...
                <div className="relative overflow-x-auto shadow-md" style={{ maxWidth: '1280px', margin: '20px auto', padding: '10px' }}>
                    <div className="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white">
                        <div>
                            ...
                            <div className="relative inline-block" style={{ marginLeft:"20px" }}>
                                ...
                                {isOpen && (
                                    ...
                                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                                        <li>
                                        <a href="/management_history_max" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                            >ล่าสุด</a>
                                        </li>
                                        <li>
                                        <a href="/management_history" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                            >ค่าเริ่มต้น</a>
                                        </li>
                                    </ul>
                                    </div>
...
export default Management_History_MIN;
