...
const Management_Concert_Match = () => {
    ...
    useEffect(() => {
        if (userId) {
            const fetchConcerts = async () => {
                try {
                    const response = await axios.get(`${API_URL}/concertsU-match`, {
                        params: {
                            id_user: userId,
            ...
            <div className="home-MN">
                ...
                <div className="relative overflow-x-auto shadow-md" style={{ maxWidth: '1280px', margin: '20px auto', padding: '10px' }}>
                    <div className="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white">
                        ...
                        <button type="button"
                                class="px-4 py-2 text-sm font-medium text-white bg-black border-t border-b border-black hover:bg-gray-800 focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-700">
                            จับคู่แล้ว
                        </button>
                        <button type="button" 
...
export default Management_Concert_Match;
