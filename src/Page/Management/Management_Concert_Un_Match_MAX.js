...
const Management_Concert_Un_Match_MAX = () => {
    ...
    const navigateToConcertUnMatchMin= () => {
        navigate("/management_un_match_min");
    };
    ...
    useEffect(() => {
        if (userId) {
            const fetchConcerts = async () => {
                try {
                    const response = await axios.get(`${API_URL}/concertsU-un-match-max`, {
                        params: {
                            id_user: userId,
            ...
            <div className="home-MN">
                ...
                <div className="relative overflow-x-auto shadow-md" style={{ maxWidth: '1280px', margin: '20px auto', padding: '10px' }}>
                    <div className="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white">
                        ...
                        <p className="font-normal text-gray-500" style={{ marginLeft:"1170px" }}>วันที่จะถึง </p>
                        <svg className="w-[20px] h-[20px] text-gray-800 dark:text-white" aria-hidden="true" onClick={navigateToConcertUnMatchMin}
...
export default Management_Concert_Un_Match_MAX;
