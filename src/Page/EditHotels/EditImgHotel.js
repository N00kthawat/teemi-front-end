...
function EditImgHotel() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.post(`${API_URL}/hotelpicture/${ID_hotel}`, { channels });
    ...
    return (
        <>
            ...
            <p className="ms-2 font-semibold text-gray-500 dark:text-gray-400" style={{ marginLeft: '50px' }}>hotel photos.</p>
